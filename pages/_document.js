    ...
    return (
      <html>
        <Head>
          ...
          <script src='https://maps.google.com/maps/api/js?key=AIzaSyArK9veHmyKP3QdYMPW1381JzFHqUwDg9U&libraries=drawing,places,weekly,geometry&language=th&region=TH' async defer></script>
        ...
        <body>
          ...
          <script src="/assets/js/maplabel.js" async defer></script>
